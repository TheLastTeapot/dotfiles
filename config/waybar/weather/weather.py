...
appid = "06274929a3e517750fde55fcf3368e3a"
...
class WeatherMan(object):
    def __init__(self, owm_api_key, city_id = 4127256, lat = 35.249859, lon = -93.048859, units = 'imperial'):
        self._api_key = owm_api_key
        self._units = 'imperial'

        self._city_id =  4127256
        self._gps = (35.249859,-93.048859)
